...
`registry.codeocean.com/published/ae32ea3a-0f5b-4a41-af9e-46166de6cc69:v1`
...
docker run --rm --gpus all \
  ...
  registry.codeocean.com/published/ae32ea3a-0f5b-4a41-af9e-46166de6cc69:v1 bash run
```
